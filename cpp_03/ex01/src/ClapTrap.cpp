...
{
    std::cout << "[SUPER CLASS] Default constructor called" << std::endl;
}

// Name constructor
ClapTrap::ClapTrap(std::string name)
{
    std::cout << "[SUPER CLASS] Name constructor called: ClapTrap is created as " << name << std::endl;
    this->_name = name;
    this->_hitPoints = 10;
...
ClapTrap::~ClapTrap()
{
    std::cout << "[SUPER CLASS] Destructor called: ClapTrap " << this->_name << " is destroyed" << std::endl;
}
...
ClapTrap& ClapTrap::operator=(const ClapTrap& other)
{
    if(this != &other)
    {
        std::cout << "[SUPER CLASS] Copy assignment operator called" << std::endl;
        this->_name = other._name;
        this->_isDead = other._isDead;
        this->_hitPoints = other._hitPoints;
        this->_energyPoints = other._energyPoints;
